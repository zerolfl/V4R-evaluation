...
attFigName={'Scale_variation' 'Aspect_ratio_variation' 'Occlusion'	'Deformation' 'Fast_camera_motion'	'In_plane_rotation' 'Out_of_plane_rotation'  'Out_of_view'	'Background_clutter' 'Similar_objects_around' 'Motion_blur'};
